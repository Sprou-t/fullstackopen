...
// request.get() is a method used to retrieve the value of a specific HTTP header from the incoming request
// eg. of header: request(eg. authorization, content-type) and response header
